...
const programs = [
  {
    ...
    image: 'https://picsum.photos/seed/prog-resilience/700/450',
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/prog-food/700/450',
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/prog-land/700/450',
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/prog-schools/700/450',
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/prog-voices/700/450',
    ...
    <section ref={sectionRef} className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* BENTO GRID AUDIT:
          ...
          Row 1: [col-1: Resilience Centers cs-1] [col-2: My Food My Power cs-1] [col-3: Her Land Her Power cs-1]
          Row 2: [col-1: ART Green Schools cs-2] [col-3: Voices from Roots cs-1]
          Placed 5/5 cards ✓
        */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {programs.slice(0, 3).map((prog, i) => (
            <div
              key={prog.id}
              className="reveal reveal-hidden bg-card rounded-3xl overflow-hidden border border-border card-hover group flex flex-col"
            ...
            >
              ...
              <div className="relative h-52 overflow-hidden shrink-0">
                ...
                <div className="absolute top-3 left-3">
                  <span className="tag-pill bg-foreground/70 backdrop-blur-sm text-primary-foreground">
                    <Icon name={prog.tagIcon as Parameters<typeof Icon>[0]['name']} size={11} />
                    {prog.tag}
                  </span>
                </div>
              </div>
              <div className="p-6 flex flex-col flex-1">
                <h2 className="font-bold text-lg text-foreground mb-3">{prog.title}</h2>
                <p className="text-sm text-muted-foreground leading-relaxed mb-4 flex-1">{prog.summary}</p>
          ...
          {/* Row 2: ART Green Schools spans 2 cols, Voices spans 1 */}
          {/* col-1 col-2: ART Green Schools cs-2 | col-3: Voices from Roots cs-1 */}
          <div
            className="reveal reveal-hidden bg-card rounded-3xl overflow-hidden border border-border card-hover group flex flex-col sm:col-span-2 lg:col-span-2"
            style={{ transitionDelay: '240ms' }}
          >
            <div className="flex flex-col sm:flex-row h-full">
              <div className="relative sm:w-1/2 h-52 sm:h-auto overflow-hidden shrink-0">
                <AppImage
                ...
                <div className="absolute top-3 left-3">
                  <span className="tag-pill bg-foreground/70 backdrop-blur-sm text-primary-foreground">
                    <Icon name={programs[3].tagIcon as Parameters<typeof Icon>[0]['name']} size={11} />
                    {programs[3].tag}
                  </span>
                </div>
              </div>
              <div className="p-6 flex flex-col flex-1 justify-between">
                <div>
                  <h2 className="font-bold text-xl text-foreground mb-3">{programs[3].title}</h2>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">{programs[3].summary}</p>
          ...
          >
            <div className="relative h-52 overflow-hidden shrink-0">
              ...
              <div className="absolute top-3 left-3">
                <span className="tag-pill bg-foreground/70 backdrop-blur-sm text-primary-foreground">
                  <Icon name={programs[4].tagIcon as Parameters<typeof Icon>[0]['name']} size={11} />
                  {programs[4].tag}
                </span>
              </div>
            </div>
            <div className="p-6 flex flex-col flex-1">
              <h2 className="font-bold text-lg text-foreground mb-3">{programs[4].title}</h2>
              <p className="text-sm text-muted-foreground leading-relaxed mb-4 flex-1">{programs[4].summary}</p>
              <div className="flex items-center justify-between">
                <div className="flex flex-wrap gap-1.5">
