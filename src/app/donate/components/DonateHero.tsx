    ...
    <section
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-32 pb-20 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm mb-8 animate-fade-up">
          ...
          <span className="section-label text-white/80">Support Community Action</span>
        </div>
        ...
        <p
          className="text-white/80 text-lg sm:text-xl font-light leading-relaxed max-w-2xl mx-auto animate-fade-up"
